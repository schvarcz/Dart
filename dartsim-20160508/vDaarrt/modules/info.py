...
class Info :
    ...
    def __afficherInfos(self,simu,daarrt2d) :
        ...
        simu.blit(self.myfont.render(self.lSpeed_string+str(daarrt2d.leftSpeed),1,(0,0,0)),(self.offsetX,self.offsetY+self.sizeWorld[1]/2 +20))
        simu.blit(self.myfont.render(self.rSpeed_string+str(daarrt2d.rightSpeed),1,(0,0,0)),(self.offsetX,self.offsetY+self.sizeWorld[1]/2 +35))
